    ...
    <div className="overflow-hidden rounded-2xl border border-border bg-surface-card shadow-xl shadow-black/20">
      ...
      <div className="p-6 sm:p-7">
        <div className="flex items-center justify-between">
          <p className="font-mono text-[11px] font-semibold uppercase tracking-wide text-primary-400">
            Friday Report
          </p>
          {isSample && (
        ...
        <p className="mt-1 font-mono text-xs text-ink-muted">{formatReportDate(report.report_date)}</p>
        ...
        <div className="mt-6 border-t border-border pt-5">
          <div className="flex items-center justify-between">
            <p className="text-xs font-semibold uppercase tracking-wide text-ink-muted">Next Steps</p>
            <span className="flex items-center gap-1.5 font-mono text-[10px] font-semibold uppercase text-primary-400">
          ...
          {steps.length > 0 ? (
            <ul className="mt-3 space-y-2">
              {steps.map((step, index) => (
                <li key={`${index}-${step}`} className="flex items-start gap-2.5 text-sm text-ink">
            ...
            <p className="mt-3 text-sm text-ink-muted">No next steps recorded yet.</p>
          )}
        </div>
      </div>
    </div>
...
function Stat({
  ...
  return (
    <div className="flex flex-col items-start gap-1">
      ...
      <p className="font-mono text-2xl font-bold leading-none text-ink">{value}</p>
