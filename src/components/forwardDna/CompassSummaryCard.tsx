  ...
  return (
    <div className="border border-border bg-surface-card p-6">
      <div className="flex items-center gap-2">
        ...
        <h3 className="font-serif text-base font-semibold text-ink">Career Compass</h3>
      </div>
      {result ? (
        <div className="mt-3">
          <p className="text-sm text-ink-muted">
            Primary archetype: <span className="font-semibold text-ink">{ARCHETYPE_LABELS[result.primary_archetype]}</span>
          </p>
          <p className="mt-1 text-sm text-ink-muted">Primary barrier: {result.primary_barrier}</p>
        ...
        <div className="mt-3">
          <p className="text-sm text-ink-muted">You haven't taken the Career Compass yet.</p>
          <Link
            to="/career-compass"
